...
vector<Problem> importProblem::importAnders() {
...
// vector<Problem> importProblem::importInstanceUVA() {
...
// 		string fileName = "instance_" + to_string(1) + ".txt";
// 		ifstream infile;
...
// 		object.pParallel = 0;	object.pVirtual = 0;
...
static vector<Problem> importProblem::importInstanceECTSP() {
